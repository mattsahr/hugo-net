...
export const image_zoom_in = function(e) {
    image_zoom_change(1);
    return preventPropagationAndDefault(e);
};

export const image_zoom_out = function(e) {
    image_zoom_change(-1);
    return preventPropagationAndDefault(e);
};
...
export const destroyZoomify = function() {
    if (!div_ref) {
        return;
    }
...
export const zoomify = function(container, image, maxWidth, maxHeight) {
