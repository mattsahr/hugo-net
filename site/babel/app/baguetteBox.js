...
const baguetteBox = () => {
    ...
    var leftArrow = '<svg width="44" height="60">' +
        ...
        closeX = '<svg width="30" height="30">' +
            ...
            '</g></svg>',
        magnifyIcon = '<svg stroke="currentColor" fill="none" stroke-width="2" ' + 
            ...
            '</svg>',
        deMagnifyIcon = '<svg stroke="currentColor" fill="none" stroke-width="2" ' +
            'viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">' +
    ...
    var options = {},
        defaults = {
            ...
            // MATTSAHR MODIFIED
            onChange: (index, other) => {
                var src = Array.prototype.slice.call( 
                    document.getElementById('gallery-list').children
                )[index].href;
    ...
    var overlay, slider, previousButton, nextButton, closeButton, expandButton, shrinkButton;
    ...
    var expandButtonClickHandler = function(event) {
        event.stopPropagation ? event.stopPropagation() : event.cancelBubble = true; // eslint-disable-line no-unused-expressions
        expandCurrentImage();
    };
    var shrinkButtonClickHandler = function(event) {
        event.stopPropagation ? event.stopPropagation() : event.cancelBubble = true; // eslint-disable-line no-unused-expressions
        shrinkCurrentImage();
    };
    ...
    function buildOverlay() {
        ...
        previousButton.className = nextButton.className = closeButton.className = 
            expandButton.className = shrinkButton.className = 'baguetteBox-button';
    ...
    function expandCurrentImage() {
        ...
        expanded.onload = function() {
            ...
            zoomify(container, expanded, width, height);
